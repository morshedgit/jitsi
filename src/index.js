...
import MyjitsiComponent from './direflow-components/myjitsi-component';

MyjitsiComponent.then((element) => {

  /**
   * Access DOM node when it's mounted
   */
  console.log('myjitsi-component is mounted on the DOM', element);
});
